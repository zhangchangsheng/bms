package com.qnz.bms.interceptor;

import com.qnz.bms.annotation.Permission;
import com.qnz.bms.result.JsonResult;
import com.qnz.bms.result.ResultCode;
...
public class ControllerInterceptor {
    ...
    /**
     * 定义拦截规则：拦截com.qnz.bms.controller包下面的所有类中，有@RequestMapping注解的方法。
     */
    @Pointcut("execution(* com.qnz.bms.controller..*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
